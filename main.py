...
def imagen_post_insta():
    ...
    # Generate image using Gemini 3.1 Flash Image (Google)
    print("Generating image with Gemini 3.1 Flash Image...")
    ...
    if not img:
        print("No images generated by Gemini 3.1 Flash Image.")
